    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                <button x-show:click="open = true"type="button"
          ...
          -->
            ...
            @auth
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  ...
                  -->
                        <div x-show="open"
                            x-on:click.away="open = false"class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <a href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-gray-700"
                                    ...
                                    @click.prevent="$root.submit();">Cerrar Cesión</a>
                            </form>
                        </div>
                    </div>
                </div>
